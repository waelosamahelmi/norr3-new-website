...
const fi = {
  ...
  home: {
    ...
    valuesCaption:
      "Our Values. Uskomme vahvasti itsenäiseen ja kokeilevaan kulttuuriin, mutta myös yhdessä tekemisen voimaan.",
    cases: {
      heading: "Cases",
  ...
  services: {
    ...
    features: {
      ...
      items: [
        ...
        { icon: "track_changes", title: "Media Analysis", body: "Ihanteellisesti optimaalisen mediastrategian rakentaminen alkaa tutkimalla saatavilla olevaa dataa – ja dataa löytyy. Tärkeää onkin miettiä, mitä kaikkea on tarpeellista analysoida." },
        ...
        { icon: "space_dashboard", title: "Intuitive Control Panel", body: "Laaja tutkimus- ja mittaustyökalupakkimme varmistaa ja todentaa suunnitelmat ja tulokset." },
        { icon: "credit_score", title: "Cost Optimization", body: "Tulospohjainen mainonta on tehokas tapa tavoittaa kohdeyleisö ja saada konkreettisia tuloksia markkinointitoimenpiteistä." },
        { icon: "verified", title: "Certified Data Accuracy", body: "Olemme erikoistuneet dynaamisiin ja html-aineistoihin sekä luovien A/B-testaukseen." },
      ],
    },
  ...
  team: {
    ...
    culture: {
      heading: "Our Culture",
      body: "4 Principles. Autamme pohjoismaisia edelläkävijäyrityksiä muuttamaan mediainvestoinnit kasvuksi ja kilpailueduksi yhdistämällä haastajan asenteen, viimeisimmän teknologian ja poikkeuksellisen osaamisen.",
      principles: [
