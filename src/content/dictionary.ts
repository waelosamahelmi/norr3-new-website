...
const fi = {
  ...
  seo: {
    ...
    feed: {
      title: "Feed — NØRR3-tiimin ajatuksia ja arkea | NØRR3",
      description:
  ...
  home: {
    ...
    valuesCaption:
      "Uskomme vahvasti itsenäiseen ja kokeilevaan kulttuuriin, mutta myös yhdessä tekemisen voimaan.",
    cases: {
      heading: "Caset",
  ...
  social: {
    pill: "FEED",
    feedHeadline: "Tiimin feed",
    feedIntro: "Ajatuksia, töitä ja arkea suoraan NØRR3:n tekijöiltä — samat ihmiset, jotka suunnittelevat, ostavat ja todentavat mediasi.",
    storiesLabel: "Tiimin tarinat",
    postsLabel: "Julkaisut",
    sideHeading: "Ihmiset mediasi takana",
    sideBody: "Jokaisella tiimiläisellä on oma profiili: osaaminen, työt ja julkaisut yhdessä paikassa.",
    teamHeading: "Tiimi",
    otherMembers: "Muut tiimiläiset",
    viewTeam: "Tutustu koko tiimiin",
    teamFeedCta: "Seuraa tiimin feediä",
    emptyTitle: "Ei vielä julkaisuja",
    emptyBody: "Tiimin ensimmäiset julkaisut ilmestyvät tänne pian. Sillä välin voit tutustua tekijöihin.",
    loadMore: "Lataa lisää",
    loading: "Ladataan…",
    loadError: "Julkaisujen lataus epäonnistui. Yritä uudelleen.",
    endOfFeed: "Olet nähnyt kaikki julkaisut.",
    taggedHeading: "Julkaisut aiheella",
    taggedEmpty: "Ladatuissa julkaisuissa ei ole tätä aihetta.",
    clearTag: "Näytä kaikki julkaisut",
    pinned: "Kiinnitetty",
    reposted: "Jaettu",
    repostedBy: "{name} jakoi tämän",
    seeMore: "…näytä lisää",
    seeLess: "Näytä vähemmän",
    justNow: "juuri nyt",
    like: "Tykkää",
    unlike: "Poista tykkäys",
    likeCountOne: "{n} tykkäys",
    likeCountMany: "{n} tykkäystä",
    commentCountOne: "{n} kommentti",
    commentCountMany: "{n} kommenttia",
    shareCountOne: "{n} jako",
    shareCountMany: "{n} jakoa",
    comments: "Kommentit",
    noComments: "Ei vielä kommentteja.",
    commentsNote: "Tiimin jäsenet kommentoivat NØRR3:n sisällönhallinnan kautta.",
    viewAllComments: "Näytä kaikki {n} kommenttia",
    share: "Jaa",
    linkCopied: "Linkki kopioitu",
    openPost: "Avaa julkaisu",
    backToFeed: "Takaisin feediin",
    moreFrom: "Lisää henkilöltä {name}",
    postBy: "Julkaisu: {name}",
    imageCount: "Kuva {i}/{n}",
    moreImages: "+{n}",
    openImage: "Avaa kuva {i}/{n}",
    close: "Sulje",
    previous: "Edellinen",
    next: "Seuraava",
    embedLoad: "Lataa sisältö palvelusta {provider}",
    embedNote: "Sisältö ladataan palvelusta {provider} vasta, kun painat.",
    viewStories: "Katso henkilön {name} tarinat",
    storyCount: "Tarina {i}/{n}",
    pause: "Tauko",
    resume: "Jatka",
    mute: "Mykistä",
    unmute: "Äänet päälle",
    ...
    posts: "Julkaisut",
    highlights: "Kohokohdat",
    postCountOne: "{n} julkaisu",
    postCountMany: "{n} julkaisua",
    noPostsYet: "{name} ei ole vielä julkaissut mitään.",
    openPortfolio: "Avaa",
...
const en: Dictionary = {
  ...
  seo: {
    ...
    feed: {
      title: "Feed — Thoughts and work from the NØRR3 team | NØRR3",
      description:
  ...
  home: {
    ...
    valuesCaption:
      "We believe strongly in an independent, experimental culture — and in the power of doing things together.",
    cases: {
      heading: "Cases",
  ...
  social: {
    pill: "FEED",
    feedHeadline: "Team feed",
    feedIntro: "Thoughts, work and everyday life straight from the people at NØRR3 — the same people who plan, buy and verify your media.",
    storiesLabel: "Team stories",
    postsLabel: "Posts",
    sideHeading: "The people behind your media",
    sideBody: "Everyone on the team has their own profile: skills, work and posts in one place.",
    teamHeading: "Team",
    otherMembers: "More from the team",
    viewTeam: "Meet the whole team",
    teamFeedCta: "Follow the team feed",
    emptyTitle: "No posts yet",
    emptyBody: "The team's first posts will appear here soon. Meanwhile, meet the people behind them.",
    loadMore: "Load more",
    loading: "Loading…",
    loadError: "Couldn't load more posts. Please try again.",
    endOfFeed: "You're all caught up.",
    taggedHeading: "Posts tagged",
    taggedEmpty: "None of the loaded posts use this tag.",
    clearTag: "Show all posts",
    pinned: "Pinned",
    reposted: "Reposted",
    repostedBy: "{name} reposted this",
    seeMore: "…see more",
    seeLess: "See less",
    justNow: "just now",
    like: "Like",
    unlike: "Remove like",
    likeCountOne: "{n} like",
    likeCountMany: "{n} likes",
    commentCountOne: "{n} comment",
    commentCountMany: "{n} comments",
    shareCountOne: "{n} repost",
    shareCountMany: "{n} reposts",
    comments: "Comments",
    noComments: "No comments yet.",
    commentsNote: "Team members comment through the NØRR3 CMS.",
    ...
    postBy: "Post by {name}",
    imageCount: "Image {i} of {n}",
    moreImages: "+{n}",
    openImage: "Open image {i} of {n}",
    close: "Close",
    previous: "Previous",
    next: "Next",
    embedLoad: "Load content from {provider}",
    embedNote: "Content from {provider} only loads when you press play.",
    viewStories: "View {name}'s stories",
    storyCount: "Story {i} of {n}",
    pause: "Pause",
    resume: "Play",
    mute: "Mute",
    unmute: "Unmute",
    ...
    noPostsYet: "{name} hasn't posted anything yet.",
    openPortfolio: "Open",
