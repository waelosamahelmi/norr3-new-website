    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-x-3 bottom-3 z-50 mx-auto w-auto max-w-[360px] rounded-[22px] border border-white/40 bg-white/70 p-5 backdrop-blur-xl sm:inset-x-auto sm:bottom-10 sm:left-6 sm:w-[calc(100vw-2rem)] sm:p-6 dark:border-white/15 dark:bg-white/10 dark:text-white"
        >
